...
% %	Diese Arbeit erweitert die Beleuchtung der Szene. 
	...
	beschrieben. Die folgende Abbildung zeigt die Abbildung eines Datensatzes, die mit dem erweiterten Emissions- und Absorptionsmodell erzeugt wurde. Das grüne Licht entstammt einer Richtungslichtquelle.
	
	\begin{figure}[ph]
		\centering
		\includegraphics[width=\textwidth]{images/chkpt.png}
		\caption{Dieses Bild wurde durch das erweiterten Emissions- und Absorptionsmodell erzeugt.}
		\label{fig:chkpt}
	\end{figure}
...
\section{Fazit}
	...
	Es wird angenommen, das die Kugeln hintereinander liegen und das Licht durch die gesamten
	...
	zum einen würde die Berechnungsdauer stark ansteigen und zum anderen, weil der Fokus dieser Arbeit
	auf der Sichtbarmachung von Informationen liegt, die Brechung würde dieses Ziel negativ beeinflussen, da die Sichtstrahlen durch die Brechung abgelenkt werden.
